############################################################################################
############################################################################################
### Sensitivity analyses: Time to treatment intensification
############################################################################################
############################################################################################
...
mod1_po_cc <- flexsurvspline(Surv(time_change_yrs, intens_event) ~ lastpre1oaddep_quant + 
...
### Save model
saveRDS(mod1_po_cc, file = "ttintens_cc_po.rds")

############################################################################################
### Section 3: Complication count model (complete case)
############################################################################################

mod2_po_cc <- flexsurvspline(Surv(time_change_yrs, intens_event) ~ lastpre1oaddep_quant + 
  age1oad + sex + disease_dur1oad_yrs + ethn_5cat_analysis + 
...
### Save model
saveRDS(mod2_po_cc, file = "ttintens_cc_po_count.rds")
...
### Run model
mod3_po_landmark <- flexsurvspline(Surv(time_change_yrs, intens_event) ~ lastpre1oaddep_quant + 
   age1oad + sex + disease_dur1oad_yrs + ethn_5cat_analysis + 
  prebmi + prehba1c + smk_qrisk2_acg + alcohol_cat + e2019_imd_decilef + gpcount1yr_excdep + 
  pre_index_date_retinopathy + pre_index_date_diabeticnephropathy + ckd3plus + pre_index_date_neuropathy +
  pre_index_date_hypertension + pre_index_date_ihd + pre_index_date_heartfailure + pre_index_date_myocardialinfarction + 
...
### Save model
saveRDS(mod3_po_landmark, file = "ttintens_cc_landmark.rds")
...
mod4_cc_tvc1 <- flexsurvspline(Surv(time_change_yrs, intens_event) ~ lastpre1oaddep_quant + 
   age1oad + sex + disease_dur1oad_yrs + ethn_5cat_analysis + 
  prebmi + prehba1c + smk_qrisk2_acg + alcohol_cat + e2019_imd_decilef + gpcount1yr_excdep + #n_diabcomps + 
  pre_index_date_retinopathy + pre_index_date_diabeticnephropathy + ckd3plus + pre_index_date_neuropathy +
  pre_index_date_hypertension + pre_index_date_ihd + pre_index_date_heartfailure + pre_index_date_myocardialinfarction + 
...
### Save model
saveRDS(mod4_cc_tvc1, file = "ttintens_tvc_check1.rds")
...
mod5_cc_tvc2 <- flexsurvspline(Surv(time_change_yrs, intens_event) ~ lastpre1oaddep_quant + 
   age1oad + sex + disease_dur1oad_yrs + ethn_5cat_analysis + 
  prebmi + prehba1c + smk_qrisk2_acg + alcohol_cat + e2019_imd_decilef + gpcount1yr_excdep + 
  pre_index_date_retinopathy + pre_index_date_diabeticnephropathy + ckd3plus + pre_index_date_neuropathy +
  pre_index_date_hypertension + pre_index_date_ihd + pre_index_date_heartfailure + pre_index_date_myocardialinfarction + 
...
### Save model
saveRDS(mod5_cc_tvc2, file = "ttintens_tvc_check2.rds")
